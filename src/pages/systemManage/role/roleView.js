        ...
        return (
            <div className="fn-pa-20">
                ...
                <div className="fn-pa-20">
                    ...
                    <div >
                        <h2 className="fn-ptb-20">查看角色</h2>

                        <div className="fn-ptb-20">
                            <Row className="fn-pt-20">
                                <Col span={6}>角色名称</Col>
                                <Col span={18}><Input disabled placeholder="角色名称"/></Col>
                            </Row>
                            <Row className="fn-pt-20">
                                <Col span={6}>角色描述</Col>
                                <Col span={18}><Input disabled type="textarea" rows={4}/></Col>
                            </Row>
                                                ...
                                                <div className="ant-table-body">
                                                    <table>
                                                        <thead className="ant-table-thead">
                                                            <tr>
                                                                <th colSpan={2}>
                                                                    <Checkbox disabled>账户功能管理</Checkbox>
                                                                </th>
                                                            </tr>
                                                        </thead>
                                                        <tbody className="ant-table-tbody">
                                                            <tr>
                                                                <td rowSpan={2}>
                                                                    <Checkbox disabled>账户功能列表</Checkbox>
                                                                </td>
                                                                <td>
                                                                    <Checkbox disabled>启用/禁用</Checkbox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <Checkbox disabled>管理</Checkbox>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
